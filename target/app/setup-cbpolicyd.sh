...
INSERT INTO quotas (PolicyID,Name,Track,Period,Verdict,Data) VALUES (6, 'Sender:user@domain','Sender:user@domain', 60, 'HOLD', 'Desculpe, mas seu limite por hora de envio foi excedido. Sua mensagem foi encaminhada para a fila de saida.');
INSERT INTO quotas_limits (QuotasID,Type,CounterLimit) VALUES(3, 'MessageCount', 6);
UPDATE policies SET Disabled = 1 WHERE ID < 6;
